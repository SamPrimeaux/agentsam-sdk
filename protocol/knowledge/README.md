...
See [Lifecycle and store roles](LIFECYCLE.md) for the proposed durable-knowledge
contract and its relationship to the existing blackboard, retrieval engine,
application databases, and provider continuation.
