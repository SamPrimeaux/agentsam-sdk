...
import { GeminiRoboticsPerceptionProvider } from '../../lib/robotics/perception/gemini-provider';
...
export function RoboticsWorkspace({
  ...
  const perceptionProvider = useRef(new GeminiRoboticsPerceptionProvider());
