...
|-------------|-----------------|------------------|-------|
| 2.0.0-alpha.identity | 2026-08-22 | `559bc37267f76790136004f5fa94a2bb3cd6a721` | Identity subpath (`./identity`); auth portal HTML from IAM peel; SDK git `c3a59d3`. |
| 2.0.0-alpha.identity.1 | _(pending npm)_ | `559bc37267f76790136004f5fa94a2bb3cd6a721` | Preview CLI + docs/export fixes; SDK git `360a3049bcfdc71f86d795019817a417048abb9a`. |
